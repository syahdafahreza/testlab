...
<head>
  <meta charset="utf-8">
  <title>Sorasaki Hina, Blue Archive | Umarkov Website</title>
  <script src="<?php echo asset_url() ?>sorasakihina/lib/spine-webgl-for-wpe.js"></script>
  <link rel="stylesheet" type="text/css" href="<?php echo asset_url() ?>sorasakihina/css/style.css">
</head>

<body>
  <canvas id="canvas"></canvas>
  <!-- <script src="<?php echo asset_url() ?>sorasakihina/js/main.js"></script> -->
  <script>
    let canvas;
    let gl;
    let shader;
    ...
    const BINARY_PATH = window.location.protocol === 'file:' ? location.href.replace(window.location.href, '<?php echo asset_url() ?>sorasakihina/assets/Hina_home.skel') : '<?php echo asset_url() ?>sorasakihina/assets/Hina_home.skel';
    const ATLAS_PATH = window.location.protocol === 'file:' ? location.href.replace(window.location.href, '<?php echo asset_url() ?>sorasakihina/assets/Hina_home.atlas') : '<?php echo asset_url() ?>sorasakihina/assets/Hina_home.atlas';
