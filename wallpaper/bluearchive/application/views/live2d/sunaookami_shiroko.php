...
<head>
  <meta charset="utf-8">
  <title>Sunaookami Shiroko, Blue Archive | Umarkov Website</title>
  <script src="<?php echo asset_url() ?>sunaookamishiroko/lib/spine-webgl-for-wpe.js"></script>
  <link rel="stylesheet" type="text/css" href="<?php echo asset_url() ?>sunaookamishiroko/css/style.css">
</head>
...
<body>
  ...
  <script>
    ...
    const BINARY_PATH = window.location.protocol === 'file:' ? location.href.replace(window.location.href, '<?php echo asset_url() ?>sunaookamishiroko/assets/Shiroko_home.skel') : '<?php echo asset_url() ?>sunaookamishiroko/assets/Shiroko_home.skel';
    const ATLAS_PATH = window.location.protocol === 'file:' ? location.href.replace(window.location.href, '<?php echo asset_url() ?>sunaookamishiroko/assets/Shiroko_home.atlas') : '<?php echo asset_url() ?>sunaookamishiroko/assets/Shiroko_home.atlas';
