...
<head>
  <meta charset="utf-8">
  <title>Shirasu Azusa (Swimsuit), Blue Archive | Umarkov Website</title>
  <script src="<?php echo asset_url() ?>shirasuazusaswimsuit/lib/spine-webgl-for-wpe.js"></script>
  <link rel="stylesheet" type="text/css" href="<?php echo asset_url() ?>shirasuazusaswimsuit/css/style.css">
</head>
...
<body>
  ...
  <script>
    ...
    const BINARY_PATH = window.location.protocol === 'file:' ? location.href.replace(window.location.href, '<?php echo asset_url() ?>shirasuazusaswimsuit/assets/Azusa_swimsuit_home.skel') : '<?php echo asset_url() ?>shirasuazusaswimsuit/assets/Azusa_swimsuit_home.skel';
    const ATLAS_PATH = window.location.protocol === 'file:' ? location.href.replace(window.location.href, '<?php echo asset_url() ?>shirasuazusaswimsuit/assets/Azusa_swimsuit_home.atlas') : '<?php echo asset_url() ?>shirasuazusaswimsuit/assets/Azusa_swimsuit_home.atlas';
    const WELCOME_ANIMATION = 'Start_Idle_01';
    const LOOPING_ANIMATION = 'Idle_01';

    let customScale = 1.61;
    let targetFps = 60;
