...
<head>
  <meta charset="utf-8">
  <title>Tendou Alice, Blue Archive | Umarkov Website</title>
  <script src="<?php echo asset_url() ?>tendoualice/lib/spine-webgl-for-wpe.js"></script>
  <link rel="stylesheet" type="text/css" href="<?php echo asset_url() ?>tendoualice/css/style.css">
</head>
...
<body>
  ...
  <script>
    ...
    const BINARY_PATH = window.location.protocol === 'file:' ? location.href.replace(window.location.href, '<?php echo asset_url() ?>tendoualice/assets/Aris_home.skel') : '<?php echo asset_url() ?>tendoualice/assets/Aris_home.skel';
    const ATLAS_PATH = window.location.protocol === 'file:' ? location.href.replace(window.location.href, '<?php echo asset_url() ?>tendoualice/assets/Aris_home.atlas') : '<?php echo asset_url() ?>tendoualice/assets/Aris_home.atlas';
