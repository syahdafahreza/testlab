...
<head>
  <meta charset="utf-8">
  <title>Waraku Chise, Blue Archive | Umarkov Website</title>
  <script src="<?php echo asset_url() ?>warakuchise/lib/spine-webgl-for-wpe.js"></script>
  <link rel="stylesheet" type="text/css" href="<?php echo asset_url() ?>warakuchise/css/style.css">
</head>
...
<body>
  ...
  <script>
    ...
    const BINARY_PATH = window.location.protocol === 'file:' ? location.href.replace(window.location.href, '<?php echo asset_url() ?>warakuchise/assets/Chise_home.skel') : '<?php echo asset_url() ?>warakuchise/assets/Chise_home.skel';
    const ATLAS_PATH = window.location.protocol === 'file:' ? location.href.replace(window.location.href, '<?php echo asset_url() ?>warakuchise/assets/Chise_home.atlas') : '<?php echo asset_url() ?>warakuchise/assets/Chise_home.atlas';
