...
<head>
  <meta charset="utf-8">
  <title>Hayase Yuuka, Blue Archive | Umarkov Website</title>
  <script src="<?php echo asset_url() ?>hayaseyuuka/lib/spine-webgl-for-wpe.js"></script>
  <link rel="stylesheet" type="text/css" href="<?php echo asset_url() ?>hayaseyuuka/css/style.css">
</head>
...
<body>
  ...
  <script>
    ...
    const BINARY_PATH = window.location.protocol === 'file:' ? location.href.replace(window.location.href, '<?php echo asset_url() ?>hayaseyuuka/assets/Yuuka_home.skel') : '<?php echo asset_url() ?>hayaseyuuka/assets/Yuuka_home.skel';
    const ATLAS_PATH = window.location.protocol === 'file:' ? location.href.replace(window.location.href, '<?php echo asset_url() ?>hayaseyuuka/assets/Yuuka_home.atlas') : '<?php echo asset_url() ?>hayaseyuuka/assets/Yuuka_home.atlas';
