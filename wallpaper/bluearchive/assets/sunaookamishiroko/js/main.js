...
const BINARY_PATH = window.location.protocol === 'file:' ? location.href.replace('./index.html', './assets/Shiroko_home.skel') : './assets/Shiroko_home.skel';
const ATLAS_PATH = window.location.protocol === 'file:' ? location.href.replace('./index.html', './assets/Shiroko_home.atlas') : './assets/Shiroko_home.atlas';
