...
const BINARY_PATH = window.location.protocol === 'file:' ? location.href.replace('./index.html', './assets/Azusa_swimsuit_home.skel') : './assets/Azusa_swimsuit_home.skel';
const ATLAS_PATH = window.location.protocol === 'file:' ? location.href.replace('./index.html', './assets/Azusa_swimsuit_home.atlas') : './assets/Azusa_swimsuit_home.atlas';
