...
const BINARY_PATH = window.location.protocol === 'file:' ? location.href.replace('window.location.href', '<?php echo asset_url() ?>/assets/Hina_home.skel') : '<?php echo asset_url() ?>/assets/Hina_home.skel';
const ATLAS_PATH = window.location.protocol === 'file:' ? location.href.replace('window.location.href', '<?php echo asset_url() ?>/assets/Hina_home.atlas') : '<?php echo asset_url() ?>/assets/Hina_home.atlas';
