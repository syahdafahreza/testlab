...
const BINARY_PATH = window.location.protocol === 'file:' ? location.href.replace('./index.html', './assets/Haruna_home.skel') : './assets/Haruna_home.skel';
const ATLAS_PATH = window.location.protocol === 'file:' ? location.href.replace('./index.html', './assets/Haruna_home.atlas') : './assets/Haruna_home.atlas';
