...
const BINARY_PATH = window.location.protocol === 'file:' ? location.href.replace('./index.html', './assets/Chise_home.skel') : './assets/Chise_home.skel';
const ATLAS_PATH = window.location.protocol === 'file:' ? location.href.replace('./index.html', './assets/Chise_home.atlas') : './assets/Chise_home.atlas';
