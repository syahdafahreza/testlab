...
const BINARY_PATH = window.location.protocol === 'file:' ? location.href.replace('./index.html', './assets/Aris_home.skel') : './assets/Aris_home.skel';
const ATLAS_PATH = window.location.protocol === 'file:' ? location.href.replace('./index.html', './assets/Aris_home.atlas') : './assets/Aris_home.atlas';
