<?php
  ...
  $result = mysqli_query($mysqli, "SELECT * from animasi");
...
<div class="navbar center">
  <ul>
    ...
    <li><a class="active" href="animation.php">Animation</a></li>
...
<div class="w3-container" id="about">
  <div class="w3-row-padding w3-padding-16 w3-center">
    ...
    <div class="w3-quarter">
        ...
        <a href=<?php echo ("#popup-video".$user_data['id'])?>><img src=<?php echo ("img/".$user_data['img_anim'])?> alt="Landscape 1" style="width:100%"></a>
        <h4><?php echo $user_data['nama']?></h4>
        <p><?php echo $user_data['keterangan']?></p>
    </div>
    <div id=<?php echo ("popup-video".$user_data['id'])?> class="modal">
        <div class="content">
            <h1 style="color: green;">
                <?php echo $user_data['nama']?>
            </h1>
            <video autoplay muted loop id="anim">
                <source src=<?php echo ("video/".$user_data['vid_anim'])?> type="video/mp4">
            </video>
            <a href="#" 
                class="box-close">
                ×
